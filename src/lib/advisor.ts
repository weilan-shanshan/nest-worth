...
输出 JSON 严格结构：
{
  ...
  "newAllocations": [
    {
      "market": "china | global | mixed",
      "type": "产品类型，如：A股宽基ETF / 美股QQQ / 港股通 / 黄金ETF / QDII / REITs / 可转债 / 美元货基 / BTC等",
      "title": "≤12字，方案标题",
...
2. newAllocations：推荐 3-4 条新投资品类，覆盖中国 + 全球，按风险分散：至少 1 条低风险、1-2 条中风险、≤1 条高风险
   ...
   - 全球市场可选：美股ETF（VOO/QQQ/VTI）、QDII基金、纳指100、海外REITs、黄金ETF、美元货基、加密货币
   - 避免推荐高度投机品种作为主仓
...
请基于上方实时市场数据 + 用户情况，输出 JSON 格式的整体增值方案。新增配置的预期收益要参考市场快照里的实际数据（如 BTC 24h 涨跌、汇率变动）做合理判断。`;
