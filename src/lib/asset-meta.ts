...
export const CATEGORIES: CategoryMeta[] = [
  ...
  { key: 'deposit',    label: '定期存款',   icon: 'i-ph-bank-duotone',          color: '#5C8FE0' },
  { key: 'fund',       label: '基金',       icon: 'i-ph-chart-pie-slice-duotone', color: '#2E9E60' },
  { key: 'stock',      label: '股票',       icon: 'i-ph-trend-up-duotone',      color: '#2E9E60' },
  { key: 'crypto',     label: '数字货币',   icon: 'i-ph-currency-btc-duotone',  color: '#F5A623' },
